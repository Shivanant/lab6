...
export function setup(): Promise<{
    ...
    allocationsStorage: import("@web3-storage/upload-api/types").AllocationsStorage;
    blobsStorage: import("@web3-storage/upload-api/types").BlobsStorage;
    tasksStorage: import("@web3-storage/upload-api/types").TasksStorage;
    receiptsStorage: import("@web3-storage/upload-api/types").ReceiptsStorage;
    getServiceConnection: () => import("@ucanto/interface").ConnectionView<import("@web3-storage/upload-api/types").Service>;
    tasksScheduler: import("@web3-storage/upload-api/types").TasksScheduler;
